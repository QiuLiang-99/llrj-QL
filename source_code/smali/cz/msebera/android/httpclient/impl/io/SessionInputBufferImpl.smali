...
.method public constructor <init>(Lcz/msebera/android/httpclient/impl/io/HttpTransportMetricsImpl;IILcz/msebera/android/httpclient/config/MessageConstraints;Ljava/nio/charset/CharsetDecoder;)V
    ...
    .end local p4    # "constraints":Lcz/msebera/android/httpclient/config/MessageConstraints;
    :goto_1
    ...
    .restart local p4    # "constraints":Lcz/msebera/android/httpclient/config/MessageConstraints;
    :cond_0
    const/16 p3, 0x200
...
.method private appendDecoded(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/nio/ByteBuffer;)I
    ...
    iput-object v2, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->cbuf:Ljava/nio/CharBuffer;

    .line 363
    :cond_1
    iget-object v2, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->decoder:Ljava/nio/charset/CharsetDecoder;
    ...
    iget-object v3, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->cbuf:Ljava/nio/CharBuffer;
...
.method private lineFromReadBuffer(Lcz/msebera/android/httpclient/util/CharArrayBuffer;I)I
    ...
    iput v4, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->bufferpos:I
    ...
    .line 346
    .local v1, "len":I
    iget-object v4, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->decoder:Ljava/nio/charset/CharsetDecoder;
    ...
    invoke-virtual {p1, v4, v2, v1}, Lcz/msebera/android/httpclient/util/CharArrayBuffer;->append([BII)V
...
.method public fillBuffer()I
    ...
    .line 144
    iget v4, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->bufferpos:I

    if-lez v4, :cond_1

    .line 145
    iget v4, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->bufferlen:I
    ...
    .line 149
    :cond_0
    iput v7, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->bufferpos:I
    ...
    .end local v1    # "len":I
    :cond_1
    iget v2, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->bufferlen:I
    ...
    invoke-direct {p0, v4, v2, v1}, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->streamRead([BII)I
...
.method public read([BII)I
    ...
    :cond_1
    iget v3, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->minChunkLimit:I
...
.method public readLine(Lcz/msebera/android/httpclient/util/CharArrayBuffer;)I
    ...
    .line 246
    iget-object v7, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->constraints:Lcz/msebera/android/httpclient/config/MessageConstraints;

    invoke-virtual {v7}, Lcz/msebera/android/httpclient/config/MessageConstraints;->getMaxLineLength()I
    ...
    invoke-virtual {v7}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->length()I
    ...
    iget v9, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->bufferpos:I
    ...
    .line 263
    new-instance v7, Lcz/msebera/android/httpclient/MessageConstraintException;

    const-string v8, "Maximum line length limit exceeded"

    invoke-direct {v7, v8}, Lcz/msebera/android/httpclient/MessageConstraintException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v7}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->isEmpty()Z
    ...
    iget-object v9, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->buffer:[B

    iget v10, p0, Lcz/msebera/android/httpclient/impl/io/SessionInputBufferImpl;->bufferpos:I

    invoke-virtual {v7, v9, v10, v2}, Lcz/msebera/android/httpclient/util/ByteArrayBuffer;->append([BII)V
