...
.method public shutdown(JLjava/util/concurrent/TimeUnit;)V
    ...
    :cond_0
    :goto_0
    iget-object v5, p0, Lcz/msebera/android/httpclient/impl/bootstrap/HttpServer;->workerExecutorService:Ljava/util/concurrent/ExecutorService;
    ...
    instance-of v6, v2, Lcz/msebera/android/httpclient/impl/bootstrap/Worker;
    ...
    .line 168
    check-cast v4, Lcz/msebera/android/httpclient/impl/bootstrap/Worker;

    .line 169
    .local v4, "worker":Lcz/msebera/android/httpclient/impl/bootstrap/Worker;
    invoke-virtual {v4}, Lcz/msebera/android/httpclient/impl/bootstrap/Worker;->getConnection()Lcz/msebera/android/httpclient/HttpServerConnection;
    ...
    .end local v4    # "worker":Lcz/msebera/android/httpclient/impl/bootstrap/Worker;
    :catch_1
    move-exception v1
...
.method public stop()V
    ...
    .line 139
    .local v1, "local":Lcz/msebera/android/httpclient/impl/bootstrap/RequestListener;
    if-eqz v1, :cond_0
    ...
    .line 150
    .end local v1    # "local":Lcz/msebera/android/httpclient/impl/bootstrap/RequestListener;
    :cond_1
    return-void

    .line 142
    .restart local v1    # "local":Lcz/msebera/android/httpclient/impl/bootstrap/RequestListener;
    :catch_0
    move-exception v0
