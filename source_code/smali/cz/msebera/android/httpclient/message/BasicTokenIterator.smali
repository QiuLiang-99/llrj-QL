...
.method public constructor <init>(Lcz/msebera/android/httpclient/HeaderIterator;)V
    ...
    iput-object v0, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->headerIt:Lcz/msebera/android/httpclient/HeaderIterator;

    .line 86
    const/4 v0, -0x1

    invoke-virtual {p0, v0}, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->findNext(I)I

    move-result v0

    iput v0, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->searchPos:I
...
.method protected findNext(I)I
    ...
    .line 171
    iget-object v3, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->headerIt:Lcz/msebera/android/httpclient/HeaderIterator;
    ...
    iput-object v3, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->currentHeader:Ljava/lang/String;
    ...
    .line 181
    :goto_1
    invoke-virtual {p0, v1}, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->findTokenStart(I)I
    ...
    iput-object v3, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->currentToken:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p0, v1}, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->findTokenSeparator(I)I
    ...
    :cond_2
    invoke-virtual {p0, v2}, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->findTokenEnd(I)I
    ...
    invoke-virtual {p0, v3, v2, v0}, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->createToken(Ljava/lang/String;II)Ljava/lang/String;
...
.method protected findTokenSeparator(I)I
    ...
    invoke-static {p1, v4}, Lcz/msebera/android/httpclient/util/Args;->notNegative(ILjava/lang/String;)I
    ...
    .line 284
    .local v1, "found":Z
    iget-object v4, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->currentHeader:Ljava/lang/String;
    ...
    .line 287
    .local v0, "ch":C
    invoke-virtual {p0, v0}, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->isTokenSeparator(C)Z
    ...
    .line 289
    :cond_0
    invoke-virtual {p0, v0}, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->isWhitespace(C)Z
    ...
    iget-object v6, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->currentHeader:Ljava/lang/String;
    ...
    invoke-direct {v4, v5}, Lcz/msebera/android/httpclient/ParseException;-><init>(Ljava/lang/String;)V
...
.method protected findTokenStart(I)I
    ...
    invoke-virtual {p0, v4}, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->isTokenChar(C)Z
    ...
    .line 251
    iget-object v4, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->headerIt:Lcz/msebera/android/httpclient/HeaderIterator;
    ...
    invoke-interface {v4}, Lcz/msebera/android/httpclient/HeaderIterator;->nextHeader()Lcz/msebera/android/httpclient/Header;
    ...
    iput-object v4, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->currentHeader:Ljava/lang/String;
...
.method public nextToken()Ljava/lang/String;
    ...
    .prologue
    .line 109
    iget-object v1, p0, Lcz/msebera/android/httpclient/message/BasicTokenIterator;->currentToken:Ljava/lang/String;
