...
.method public addField(Lcz/msebera/android/httpclient/entity/mime/MinimalField;)V
    ...
    .end local v1    # "values":Ljava/util/List;, "Ljava/util/List<Lcz/msebera/android/httpclient/entity/mime/MinimalField;>;"
    invoke-direct {v1}, Ljava/util/LinkedList;-><init>()V

    .line 61
    .restart local v1    # "values":Ljava/util/List;, "Ljava/util/List<Lcz/msebera/android/httpclient/entity/mime/MinimalField;>;"
    iget-object v2, p0, Lcz/msebera/android/httpclient/entity/mime/Header;->fieldMap:Ljava/util/Map;
...
.method public getField(Ljava/lang/String;)Lcz/msebera/android/httpclient/entity/mime/MinimalField;
    ...
    .line 76
    .local v0, "key":Ljava/lang/String;
    iget-object v3, p0, Lcz/msebera/android/httpclient/entity/mime/Header;->fieldMap:Ljava/util/Map;
...
.method public removeFields(Ljava/lang/String;)I
    ...
    .line 102
    .local v1, "removed":Ljava/util/List;, "Ljava/util/List<Lcz/msebera/android/httpclient/entity/mime/MinimalField;>;"
    if-eqz v1, :cond_0
...
.method public setField(Lcz/msebera/android/httpclient/entity/mime/MinimalField;)V
    ...
    iget-object v6, p0, Lcz/msebera/android/httpclient/entity/mime/Header;->fieldMap:Ljava/util/Map;
    ...
    .line 115
    .local v5, "list":Ljava/util/List;, "Ljava/util/List<Lcz/msebera/android/httpclient/entity/mime/MinimalField;>;"
    if-eqz v5, :cond_1
    ...
    .line 123
    .local v2, "index":I
    iget-object v6, p0, Lcz/msebera/android/httpclient/entity/mime/Header;->fields:Ljava/util/List;

    invoke-interface {v6}, Ljava/util/List;->iterator()Ljava/util/Iterator;

    move-result-object v3

    .local v3, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/entity/mime/MinimalField;>;"
    :goto_1
    ...
    .line 125
    .local v0, "f":Lcz/msebera/android/httpclient/entity/mime/MinimalField;
    invoke-virtual {v0}, Lcz/msebera/android/httpclient/entity/mime/MinimalField;->getName()Ljava/lang/String;
    ...
    .line 132
    .end local v0    # "f":Lcz/msebera/android/httpclient/entity/mime/MinimalField;
    :cond_4
    iget-object v6, p0, Lcz/msebera/android/httpclient/entity/mime/Header;->fields:Ljava/util/List;
